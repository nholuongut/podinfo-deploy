...
import (
	...
	"github.com/nholuongut/podinfo-deploy/pkg/api/grpc"
	"github.com/nholuongut/podinfo-deploy/pkg/api/http"
...
func main() {
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/nholuongut/podinfo-deploy/gh-pages/cuddle_clap.gif")
