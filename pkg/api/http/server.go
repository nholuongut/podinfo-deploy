...
import (
	...
	_ "github.com/nholuongut/podinfo-deploy/pkg/api/http/docs"
...
// @contact.url https://github.com/nholuongut/podinfo-deploy

// @license.name MIT License
// @license.url https://github.com/nholuongut/podinfo-deploy/blob/master/LICENSE
