...
Podinfo is used by CNCF projects like [Flux](https://github.com/nholuongut/flux)
...
[GitHub Container Registry](https://github.com/nholuongut/podinfo-deploy/pkgs/container/charts%2Fpodinfo)
...
```console
$ helm upgrade -i my-release oci://ghcr.io/nholuongut/charts/podinfo
```

To verify a chart with Cosign:

```console
$ cosign verify ghcr.io/nholuongut/charts/podinfo:<VERSION>
```
...
| `image.repository`                | `nholuongut/podinfo-deploy` | Image repository                                                                                                       |
